...
const exportPDF = () => {
  ...
  const parts = [
    ...
    '<div class="info-row"><span class="info-label">Status Filter:</span> ' + statusFilterText + '</div></div>',
    '<table><thead><tr><th>Time</th><th>Panel</th><th>Status</th><th>Details</th></tr></thead><tbody>',
    tableRows,
    '</tbody></table><div class="footer"><p>This report was generated by AMC (AirNav Monitoring & Control) System</p><p>© 2026 AirNav. All rights reserved.</p></div>',
